-- Migration: Enrich conversation_logs with structured data
...
-- SELECT column_name, data_type FROM information_schema.columns WHERE table_name = 'conversation_logs';
